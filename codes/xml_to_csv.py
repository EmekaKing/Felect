# -*- coding: utf-8 -*-
"""
Created on Fri Oct 16 15:20:07 2020

@author: Emeka

Usage:
# Create train csv sample:
python xml_to_csv.py -i [PATH_TO_IMAGES_FOLDER]/train -o [PATH_TO_ANNOTATIONS_FOLDER]/train_labels.csv

# Create train csv sample:
python xml_to_csv.py -i [PATH_TO_IMAGES_FOLDER]/validation -o [PATH_TO_ANNOTATIONS_FOLDER]/valid_labels.csv

# Create test csv sample:
...
def main():
    ...
    if args.labelMapDir:
        ...
        label_map_path = os.path.join(args.labelMapDir, "t_label_map.pbtxt")
